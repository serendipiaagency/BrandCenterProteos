        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(400px, 1fr)); gap: 2rem; margin-bottom: 2rem;">
          ...
          <div style="background: #f9fafb; border-radius: 12px; overflow: hidden; border: 2px solid #e5e7eb;">
            ...
            <div style="padding: 1.5rem;">
              ...
              <div style="display: flex; justify-content: space-between; align-items: center; padding-top: 1rem; border-top: 1px solid #e5e7eb;">
                <span style="font-size: 0.875rem; color: #9ca3af;">26.81 MB</span>
                <a href="https://brandcenter.pbserum.com/api/files/Brand Center  ENG.mp4" download style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.5rem 1rem; background: #002f57; color: white; text-decoration: none; border-radius: 6px; font-size: 0.875rem; font-weight: 500; transition: background 0.2s;">
                  <i class="fas fa-download"></i>
                  Download
                </a>
              </div>
          ...
          <div style="background: #f9fafb; border-radius: 12px; overflow: hidden; border: 2px solid #e5e7eb;">
            ...
            <div style="padding: 1.5rem;">
              ...
              <div style="display: flex; justify-content: space-between; align-items: center; padding-top: 1rem; border-top: 1px solid #e5e7eb;">
                <span style="font-size: 0.875rem; color: #9ca3af;">26.78 MB</span>
                <a href="https://brandcenter.pbserum.com/api/files/Brand Center  ESP.mp4" download style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.5rem 1rem; background: #002f57; color: white; text-decoration: none; border-radius: 6px; font-size: 0.875rem; font-weight: 500; transition: background 0.2s;">
                  <i class="fas fa-download"></i>
                  Download
                </a>
              </div>
