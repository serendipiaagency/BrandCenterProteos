          ...
          <div style="background: #f9fafb; border-radius: 12px; overflow: hidden; border: 2px solid #e5e7eb;">
            ...
            <div style="padding: 1.5rem;">
              ...
              <div style="display: flex; justify-content: space-between; align-items: center; padding-top: 1rem; border-top: 1px solid #e5e7eb;">
                <span style="font-size: 0.875rem; color: var(--gray-500);">29.73 MB</span>
                <a href="https://brandcenter.pbserum.com/api/files/VIDEOS/Brand Center Video ENG (1).mp4" download class="btn btn-primary" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.5rem 1rem; font-size: 0.875rem;">
                  <i class="fas fa-download"></i>
                  Download
                </a>
              </div>
